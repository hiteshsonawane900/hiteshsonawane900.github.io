    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div  id="contact-linkedin">
                            ...
                            <a href="https://www.linkedin.com/in/hitesh-sonawane23" rel="noreferrer" target="_blank">
                                <p>hitesh-sonawane</p>
                            </a>
                        </div>
                        ...
                        <div id="contact-phone">
                            ...
                            <a href="tel:+91 9029263481" rel="noreferrer" target="_blank">
                                <p>+91 9029263481</p>
                            </a>
                        </div>
                        <div id="contact-email">
                            ...
                            <a href='mailto:hiteshsonawane900@gmail.com' rel="noreferrer" target="_blank"><p>hiteshsonawane900@gmail.com</p></a>
                        </div>
                        <div>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Kalyan,Maharashtra</p>
                            <a href="https://www.google.com/maps/place/Kalyan,+Maharashtra/@19.2402382,73.0889494,13z/data=!3m1!4b1!4m6!3m5!1s0x3be796f457b1b76f:0x35df463ca445bd26!8m2!3d19.2403305!4d73.1305395!16zL20vMDJyZnNz?entry=ttu" rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2023 Hitesh. Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
